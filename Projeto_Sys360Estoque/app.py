...
if __name__ == "__main__":
    ...
    # 1. Simplesmente criamos uma instância da nossa App
    # Ela já sabe se deve ser ThemedTk ou tk.Tk
    app = App()

    # 2. Ainda precisamos aplicar o estilo ao botão
    estilo = ttk.Style(app)
    estilo.configure("Accent.TButton", foreground='Silver', font=('Helvetica', 9, 'bold'))
    
    # 3. Rodamos o loop principal
    app.mainloop()